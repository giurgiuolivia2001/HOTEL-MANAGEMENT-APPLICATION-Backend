...
import ro.fortech.project.payload.request.AddProductRequest;
import ro.fortech.project.payload.request.AddUserRequest;
import ro.fortech.project.payload.request.UpdateProductRequest;
import ro.fortech.project.payload.request.UpdateUserRequest;
import ro.fortech.project.payload.response.MessageResponse;
import ro.fortech.project.payload.response.ProductResponse;
import ro.fortech.project.services.GenericService;
